...
///  @file logg.h Global import header

#ifndef LOGG_LOGG_H
#define LOGG_LOGG_H

#include "version.h" // Library version
#include "logdef.h"  // Logs structures and enums
//#include "logger.h"  // Public logg functions
 ...
 *
 * # Getting Started
 * You can access to Logg library using this header file (logg.h).
 *
 ...
 *
 * This levels are defined in the file logdef.h.
 * @see logdef.h
 *
 * @see logger.h
 *
